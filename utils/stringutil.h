...
template <typename T>
struct TypeInfo {
    enum { has_sign = 0, max_size = 5 };
};

template <>
struct TypeInfo<uint8_t> {
    enum { has_sign = 0, max_size = 3 };
};
template <>
struct TypeInfo<int8_t> {
    enum { has_sign = 1, max_size = 4 };
};
template <>
...
struct TypeInfo<int16_t> {
    enum { has_sign = 1, max_size = 6 };
};
template <>
struct TypeInfo<uint32_t> {
    enum { has_sign = 0, max_size = 10 };
};
template <>
struct TypeInfo<int32_t> {
    enum { has_sign = 1, max_size = 11 };
};
